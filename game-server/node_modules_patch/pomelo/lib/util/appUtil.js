...
module.exports.loadDefaultComponents = function(app) {
  ...
  if (app.serverType === Constants.Reserved.MASTER) {
    ...
    if(app.isFrontend()) {
      ...
      if(app.connectorType == "socketio"){
		  connectorConfig.connector = pomelo.connectors.sioconnector;
	  }
	  app.load(pomelo.connector, connectorConfig);
...
var processArgs = function(app, args) {
  ...
  // 修改人:苏锐 添加连接类型的参数,默认为全局配置
  var connectorType = args.connectorType || "";
  ...
  app.set(Constants.Reserved.CONNECTOR_TYPE, connectorType, true);
